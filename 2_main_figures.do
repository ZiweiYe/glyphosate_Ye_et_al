********************************************************************************
*				program: prepare data for main text figures					   *			
*				written by: Ziwei Ye										   *
* 				date: 10/13/2020											   *
*				update:	03/05/2021										       *
********************************************************************************
...
export delimited using "$root\Github_new\8_Rfigure\fig1a.csv", datafmt replace
...
export delimited using "$root\Github_new\8_Rfigure\fig1b.csv", datafmt replace

*---------------------------fig1c----------------------------------------------*
use "$dt\wcount_use", clear 
collapse (sum) wcount_cum_*, by(year)
export delimited using "$root\Github_new\8_Rfigure\fig1c.csv", datafmt replace
...
export delimited using "$root\Github_new\8_Rfigure\fig1d.csv", datafmt replace
