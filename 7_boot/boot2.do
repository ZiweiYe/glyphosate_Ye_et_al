...
********************************************************************************
use "C:\Users\叶\Desktop\temp_Ziwei\estim_idnum_10", clear
...
bootstrap r(blnp) r(bwcount) r(bgt) r(btill) r(bv1hat) ///
	...
	reject(e(converged)!=1) reps(1000) seed(0234ik) idcluster(newid):estim_boot
est store boot
test _bs_5 

estadd scalar chi2=r(chi2)

cd "C:\Users\叶\Desktop\temp_Ziwei"
