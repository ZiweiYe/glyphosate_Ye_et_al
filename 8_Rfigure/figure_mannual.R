...
# 2. Fig 2: data plot for all, pooled-----------------------------------------------------------
# 2.1 prepare data
...
# 3. Fig.4 & Fig.5: simulation ------------------------------------------------------

# 3.1 initialize EDM parameter vector 
...
# 3.4 plots: welfare effects (Fig. 5)
...
# 3.5 plot: equilibrium solutions (Fig.4)
# 3.5.1 prepare data 
...
# 4.2 combine panels into one figure with separate legend 
...
# 6. Fig. S4: data plot for price, by year ------------------------------------------------------
